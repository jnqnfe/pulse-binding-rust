...
extern "C" {
    ...
    pub fn pa_stream_get_context(p: *mut pa_stream) -> *mut ::context::pa_context;
    ...
    pub fn pa_stream_begin_write(p: *mut pa_stream, data: *mut *mut c_void, nbytes: *mut usize) -> i32;
    pub fn pa_stream_cancel_write(p: *mut pa_stream) -> i32;
    pub fn pa_stream_write(p: *mut pa_stream, data: *const c_void, nbytes: usize, free_cb: ::def::pa_free_cb_t, offset: i64, seek: pa_seek_mode_t) -> i32;
    pub fn pa_stream_write_ext_free(p: *mut pa_stream, data: *const c_void, nbytes: usize, free_cb: ::def::pa_free_cb_t, free_cb_data: *mut c_void, offset: i64, seek: pa_seek_mode_t) -> i32;
    pub fn pa_stream_peek(p: *mut pa_stream, data: *mut *const c_void, nbytes: *mut usize) -> i32;
    pub fn pa_stream_drop(p: *mut pa_stream) -> i32;
    ...
    pub fn pa_stream_update_timing_info(p: *mut pa_stream, cb: pa_stream_success_cb_t, userdata: *mut c_void) -> *mut ::operation::pa_operation;
    ...
    pub fn pa_stream_set_overflow_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_get_underflow_index(p: *mut pa_stream) -> i64;
    pub fn pa_stream_set_underflow_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_started_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_latency_update_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_moved_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_suspended_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_event_callback(p: *mut pa_stream, cb: pa_stream_event_cb_t, userdata: *mut c_void);
    pub fn pa_stream_set_buffer_attr_callback(p: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void);
